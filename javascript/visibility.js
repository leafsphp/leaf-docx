...
window.loadFakeContent = function() {
  ...
  var
    ...
    $content = $('<h3 class="ui header">Loaded Content #' + count + '</h3><img alt="pic" class="ui wireframe image" src="/images/wireframe/paragraph.png"><img alt="pic" class="ui wireframe image" src="/images/wireframe/paragraph.png"><img alt="pic" class="ui wireframe image" src="/images/wireframe/paragraph.png">')
  ;
  if(count <= 5) {
